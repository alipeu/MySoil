...
hitungBtn.addEventListener('click', function() {
    ...
    else if(p4 == 'Klei berat') cp4 = 3 * 0.07;
    else if(p4 == 'Lempung berpasir' || p4 == 'Klei' || p4 == 'Klei berpasir') cp4 = 4 * 0.07;
    else if(p4 == 'Klei berdebu' || p4 == 'Debu' || p4 == 'Lempung berliat') cp4 = 5 * 0.07;
    else if(p4 == 'Lempung klei berdebu' || p4 == 'Lempung klei berpasir' || p4 == 'Lempung berdebu') cp4 = 6 * 0.07;
